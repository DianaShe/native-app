...
import {
  ...
  handleAddPostFulfilled,
  handleError,
  handleFetchPostsFulfilled,
  handleFulfilled,
  handleLikes,
  handlePending,
} from "./handlers";
...
const postsSlice = createSlice({
  ...
  extraReducers: (builder) =>
    builder
      ...
      .addMatcher(
        isAnyOf(addPost.rejected, fetchPosts.rejected, addComment.rejected),
        handleError
      )
      .addMatcher(
        isAnyOf(addPost.pending, fetchPosts.pending, addComment.pending),
        handlePending
      )
      .addMatcher(
        isAnyOf(
